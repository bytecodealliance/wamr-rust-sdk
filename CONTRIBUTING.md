...
License
=======
WAMR-Rust-SDK uses the same license as LLVM: the `Apache 2.0 license` with the LLVM
...
Coding Style
===============================
Please use `cargo fmt` to maintain the coding style.

Report bugs
===================
We use GitHub issues to track public bugs. Report a bug by [open a new issue](https://github.com/bytecodealliance/wamr-rust-sdk/issues/new).

Code of Conduct
===============

WAMR-Rust-SDK is a [Bytecode Alliance](https://bytecodealliance.org/) project, and follows the Bytecode Alliance's [Code of Conduct](CODE_OF_CONDUCT.md) and [Organizational Code of Conduct](ORG_CODE_OF_CONDUCT.md).
